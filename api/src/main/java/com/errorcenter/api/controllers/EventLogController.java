...
public class EventLogController {
    ...
    @GetMapping
    public List<EventLog> findByDescription(@PathParam("description") String description,
                                            ...
                                            Pageable pageable) {
        return eventLogService.findByFilters(description, level, log, origin, amount, date, pageable);
    }

    @PostMapping
    public ResponseEntity save(@Valid @RequestBody EventLogDTO eventLogDTO) {
